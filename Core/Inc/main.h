...
#define PD_Pin GPIO_PIN_14
#define PD_GPIO_Port GPIOE
...
#define AlarmOn_Pin GPIO_PIN_10
#define AlarmOn_GPIO_Port GPIOD
#define useAlarm_Pin GPIO_PIN_11
#define useAlarm_GPIO_Port GPIOD
